...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, DisplayName = "Fill Data Table from CSV String", Category = "CB_Datas")
	...
	/**
		...
		* @return	True if the operation succeeds, check the log for errors if it didn't succeed.
		*/
	UFUNCTION(BlueprintCallable, DisplayName = "Fill Data Table from CSV File", Category = "CB_Datas")
	...
	/**
		...
		* @return	True if the operation succeeds, check the log for errors if it didn't succeed.
		*/
	UFUNCTION(BlueprintCallable, DisplayName = "Fill Data Table from JSON String", Category = "CB_Datas")
